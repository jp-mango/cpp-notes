...
int main() {
  ...
  cout << "\n - Output 2:" << endl;
  for (int c{1}; c <= 100; c++) { // prints value of c, 1
    cout << c
  ...
  // Ranged-based For Loops - When you need to access each element of a
  // container or an array directly and don’t need the index.
  ...
  cout << endl;
  // While Loops - iterates while a condition remains true, check condition at
  // the BEGINNING the next iteration
  cout << "\n----- While Loops ----- " << endl;
  cout << "\n - Example 1: " << endl;
  cout << "int e{1};" << endl;
  cout << "while (e <= 5)" << endl;
  ...
  cout << endl;
  // Do-While Loop - iterates while the condition remains true, checks condition
  ...
  cout << "\n - Output 1: " << endl;
  int number{}; // must be declared outside of the loop if used in loop
                // condition
  do {
  ...
  cout << "Thanks." << endl;
  // Continue - no further statements in the loop are executed and the loop
  // restarts Break - no further statements in the loop are executed and the
  // loop ends
  cout << "\n----- Continue & Break ----- " << endl;
  ...
  // Nested Loops - a loop within a loop. The inner loop finished before the
  // outer.
  cout << "\n----- Nested Loops ----- " << endl;
